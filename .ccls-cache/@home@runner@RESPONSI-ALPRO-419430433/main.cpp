...
void Responsi::proses(){
  ...
  cin>>jarak;
    ...
    if(harga>=70000 && harga<=90000){
      ...
      cout<<"Anda mendapatkan voucher diskon 15%"<<endl;
      diskon = ongkir*0.15;
    }else if(harga>=110000 && harga<=140000){
      cout<<"Anda mendapatkan voucher diskon 20%"<<endl;
      diskon = ongkir*0.20;
    }else if(harga>=140000 && harga<=170000){
      cout<<"Anda mendapatkan voucher diskon 25%"<<endl;
      diskon = ongkir*0.25;
    }else if(harga>=170000 && harga<=210000){
      cout<<"Anda mendapatkan voucher diskon 30%"<<endl;
      diskon = ongkir*0.30;
    }else if(harga>=210000 && harga<=250000){
      cout<<"Anda mendapatkan voucher diskon 35%"<<endl;
      diskon = ongkir*0.35;
      jumongkir= ongkir-diskon;   
	}else if(harga>=250000){
      cout<<"Anda mendapatkan voucher diskon 40%"<<endl;
      diskon = ongkir*0.40;
    }else{
